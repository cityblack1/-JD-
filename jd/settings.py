...
SECRET_KEY = '(eqsw#gc(i1ju%r(9hfwo_bdgcn8ie(+4kza$16bs=c7_()e0%'
...
# --------------  验证码  ---------------- #
# 验证码生成模式  详情参考文档 http://django-simple-captcha.readthedocs.io/en/latest/advanced.html#generators-ref
CAPTCHA_CHALLENGE_FUNCT = 'captcha.helpers.math_challenge'
CAPTCHA_LETTER_ROTATION = (-3, 5)
